...
module.exports = (condition) => {
    ...
    if(first_type_condition.type){
        ...
        if(value_first_condition === 'none') value_first_condition = '';
    }
    ...
    if(second_type_condition.type){
        ...
        if(value_second_condition === 'none') value_second_condition = '';
    }
    ...
    users_info.forEach(item => {
        ...
        if(logic_type_condition.type == 0){
            if(first_condition == true) users[users.length] = users_info_get;
        }else if(logic_type_condition.type == 1){
            if(first_condition == true && second_condition == true) users[users.length] = users_info_get;
